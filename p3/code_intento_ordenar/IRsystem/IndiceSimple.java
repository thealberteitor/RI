	...
	public void indexarDocumentos(){
		try{
			...
			for (CSVRecord csvRecord : csvParser) {
				...
				}else if(movie_number==TOTAL/4){
					System.out.println("Indexing... 25%");
				}else if(movie_number==TOTAL/2){
					System.out.println("Indexing... 50%");
				}else if(movie_number==3*TOTAL/4){
					System.out.println("Indexing... 75%");
				}else if(movie_number==TOTAL){
					System.out.println("Indexing... 100%\n\n");
				}
