...
public class Searcher_interfaz{
    ...
    public TopDocs IndexBooleanQuery(String campo, Analyzer analyzer, String consulta) throws IOException {
		SortField sf = new SortField("Release Year", SortField.Type.INT, true);
		//Sort sort = new Sort(new SortedNumericSortField("age", SortField.Type.LONG, true));
		//SortedNumericSortField sf = new SortedNumericSortField("Release Year", SortField.Type.INT, true);
		
		// Campo de ordenacion curso,entero, decreciente
		sf.setMissingValue(0); //Valor por defecto cuando los docs no tiene dicho campo
        ...
        TopDocs tdocs = searcher.search(bq,cuantos,orden);
